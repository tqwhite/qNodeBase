...
Object.prototype.numericToArray = function() {
		...
		for (var i in this) {
console.dir({"this [environmentChanges.js.Object.prototype.numericToArray]":this});

console.log("i="+i+" [environmentChanges.js.Object.prototype.numericToArray]");

console.log("this.hasOwnProperty(i)="+this.hasOwnProperty(i)+" [environmentChanges.js.Object.prototype.numericToArray]");
		...
		for (var i=0; i<maxIndex+1; i++){
			...
			outArray.push(typeof(workingArray[i])!='undefined'?workingArray[i]:undef());
		}
