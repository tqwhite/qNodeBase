...
// 		);
	...
	self.parseCommandLine = function(args) {
		...
		*/
		...
		return {
			calledFromCommandLine: (this.employerFilename && process.argv && process.argv[1].toString().match(new RegExp(this.employerFilename+'$'))!=null),
			fileList: fileList,
...
self.tsvToJsObjectList=inString=>{
...
self.isTrue=inData=>{
console.log("inData="+inData+" [qtoolsBase.js.moduleFunction]");

return (inData.toString().toLowerCase()==='true')};
